...
export function AuthenticationMagicLinkTemplate({ authLink, userEmail }: AuthenticationMagicLinkTemplateProps) {
  const previewText = `Faça login no upload.video`
        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-465px]">
            ...
            <Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">
              Faça login no upload.video
            </Heading>
            <Text className="text-black text-[14px] leading-[24px]">
              Você solicitou um link para login no upload.video através do email{' '}
              {userEmail}.
            </Text>
